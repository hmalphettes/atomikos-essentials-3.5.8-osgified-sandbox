    ...
    public boolean recover () throws SysException
    {
        ...
        while ( resources.hasMoreElements () ) {
            ...
            if ( res.recover ( this ) ) {
                ...
                // XATransactionalResource xares =
                // ( XATransactionalResource ) res;
                // xid_ = xares.getXidFactory().createXid ( tid_ , resourcename_
                // );
            }

        }

        // FOLLOWING REMOVED: failure to recover should be dealt with
        // by caller.

        // if ( ! recovered ) {
        // //check if heuristic state, and if so
        // //then do NOT mind about not recovering in resource.
        // //this is because the resource may not even know
        // //about the heuristic state: if the TM initiated
        // //heuristics, the resource will not know.
        // if ( ! (state_.equals ( TxState.HEUR_ABORTED ) ||
        // state_.equals ( TxState.HEUR_MIXED ) ||
        // state_.equals ( TxState.HEUR_COMMITTED ) ||
        // state_.equals ( TxState.HEUR_HAZARD ) ) ) {
        // Console console = Configuration.getConsole();
        // if ( console != null )
        // console.println ( "WARNING: no resource found to recover " +
        // "XA participant " + toString() );
        // }
        // else {
        // System.err.println ( "WARNING: no resource found to recover " +
        // "XA participant " + toString() );
        // }
        //	      
        // }
